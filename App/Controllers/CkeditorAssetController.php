...
/**
 * CKEditor 5 self-hosted dosyalarını public/ui-vendor/ckeditor5/ altından sunar.
 * Geriye dönük uyumluluk için Content/js/ckeditor5 de desteklenir.
 */
class CkeditorAssetController
{
    ...
    private function resolveAssetPath(string $basePath, string $path): ?string
    {
        ...
        $roots = [
            $basePath . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'ui-vendor' . DIRECTORY_SEPARATOR . 'ckeditor5',
            $basePath . DIRECTORY_SEPARATOR . 'Content' . DIRECTORY_SEPARATOR . 'js' . DIRECTORY_SEPARATOR . 'ckeditor5',
        ];
