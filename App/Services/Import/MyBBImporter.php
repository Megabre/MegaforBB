...
use App\Services\Import\Steps\ImportMyBBForums;
use App\Services\Import\Steps\ImportMyBBPolls;
use App\Services\Import\Steps\ImportMyBBPosts;
use App\Services\Import\Steps\ImportMyBBRoles;
use App\Services\Import\Steps\ImportMyBBSocial;
use App\Services\Import\Steps\ImportMyBBTopics;
use App\Services\Import\Steps\ImportMyBBUsers;
...
class MyBBImporter
{
    ...
    private string $source = 'mybb';

    public function __construct(\PDO $targetPdo, ?\PDO $sourcePdo = null, string $source = 'mybb')
    {
    ...
    public function getSteps(): array
    {
        $steps = [
            new ImportMyBBRoles(),
            new ImportMyBBUsers(),
            new ImportMyBBForums(),
            new ImportMyBBTopics(),
            new ImportMyBBPosts(),
            new ImportMyBBPolls(),
            new ImportMyBBSocial(),
            new SyncCounters(),
        ];
